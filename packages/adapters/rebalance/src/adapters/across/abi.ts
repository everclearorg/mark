export const ACROSS_SPOKE_ABI = [
  {
    inputs: [
      ...
      { internalType: 'contract ITokenMessenger', name: '_cctpTokenMessenger', type: 'address' },
    ],
  ...
  { inputs: [], name: 'InsufficientSpokePoolBalanceToExecuteLeaf', type: 'error' },
  ...
  { inputs: [{ internalType: 'bytes', name: 'data', type: 'bytes' }], name: 'LowLevelCallFailed', type: 'error' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'bytes32', name: 'l2TokenAddress', type: 'bytes32' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bool', name: 'deferredRefunds', type: 'bool' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bytes32', name: 'exclusiveRelayer', type: 'bytes32' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint32', name: 'fillDeadline', type: 'uint32' },
      { indexed: false, internalType: 'uint32', name: 'exclusivityDeadline', type: 'uint32' },
      { indexed: true, internalType: 'bytes32', name: 'depositor', type: 'bytes32' },
      { indexed: false, internalType: 'bytes32', name: 'recipient', type: 'bytes32' },
      { indexed: false, internalType: 'bytes32', name: 'exclusiveRelayer', type: 'bytes32' },
      { indexed: false, internalType: 'bytes', name: 'message', type: 'bytes' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'uint256', name: 'depositId', type: 'uint256' },
      { indexed: true, internalType: 'bytes32', name: 'depositor', type: 'bytes32' },
      { indexed: false, internalType: 'bytes32', name: 'updatedRecipient', type: 'bytes32' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'address', name: 'newL2GatewayRouter', type: 'address' }],
    name: 'SetL2GatewayRouter',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'address', name: 'newWithdrawalRecipient', type: 'address' }],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_withdrawalRecipient', type: 'address' },
    ],
  ...
  {
    inputs: [{ internalType: 'address', name: 'newL2GatewayRouter', type: 'address' }],
    name: 'setL2GatewayRouter',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'address', name: 'newWithdrawalRecipient', type: 'address' }],
    name: 'setWithdrawalRecipient',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
