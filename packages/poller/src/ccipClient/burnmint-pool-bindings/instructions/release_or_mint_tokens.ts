...
export const layout = borsh.struct([types.ReleaseOrMintInV1.layout('release_or_mint')]);
...
export function release_or_mint_tokens(
  ...
  const len = layout.encode(
    {
      release_or_mint: types.ReleaseOrMintInV1.toEncodable(args.release_or_mint),
    },
    buffer,
  );
