...
export class State {
  ...
  static readonly discriminator = Buffer.from([216, 146, 107, 94, 104, 75, 182, 177]);

  static readonly layout = borsh.struct([borsh.u8('version'), types.BaseConfig.layout('config')]);
  ...
  static async fetch(c: Connection, address: PublicKey, programId: PublicKey = PROGRAM_ID): Promise<State | null> {
