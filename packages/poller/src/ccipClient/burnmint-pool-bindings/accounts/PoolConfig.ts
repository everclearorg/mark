...
export class PoolConfig {
  ...
  static readonly discriminator = Buffer.from([26, 108, 14, 123, 116, 230, 129, 43]);
  ...
  static async fetch(c: Connection, address: PublicKey, programId: PublicKey = PROGRAM_ID): Promise<PoolConfig | null> {
