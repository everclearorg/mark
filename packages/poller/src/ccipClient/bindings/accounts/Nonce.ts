...
export class Nonce {
  ...
  static readonly discriminator = Buffer.from([143, 197, 147, 95, 106, 165, 50, 43]);

  static readonly layout = borsh.struct([borsh.u8('version'), borsh.u64('counter')]);
  ...
  static async fetch(c: Connection, address: PublicKey, programId: PublicKey = PROGRAM_ID): Promise<Nonce | null> {
