...
export class DestChain {
  ...
  static readonly discriminator = Buffer.from([77, 18, 241, 132, 212, 54, 218, 16]);
  ...
  static async fetch(c: Connection, address: PublicKey, programId: PublicKey = PROGRAM_ID): Promise<DestChain | null> {
