...
export class Config {
  ...
  static readonly discriminator = Buffer.from([155, 12, 170, 224, 30, 250, 204, 130]);
  ...
  static async fetch(c: Connection, address: PublicKey, programId: PublicKey = PROGRAM_ID): Promise<Config | null> {
