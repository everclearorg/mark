...
export class BaseChain {
  ...
  static fromDecoded(obj: any) {
    return new BaseChain({
      ...
      inboundRateLimit: types.RateLimitTokenBucket.fromDecoded(obj.inboundRateLimit),
      outboundRateLimit: types.RateLimitTokenBucket.fromDecoded(obj.outboundRateLimit),
    });
  }
  ...
  static toEncodable(fields: BaseChainFields) {
    return {
      ...
      inboundRateLimit: types.RateLimitTokenBucket.toEncodable(fields.inboundRateLimit),
      outboundRateLimit: types.RateLimitTokenBucket.toEncodable(fields.outboundRateLimit),
    };
  }
  ...
  static fromJSON(obj: BaseChainJSON): BaseChain {
    return new BaseChain({
      ...
      inboundRateLimit: types.RateLimitTokenBucket.fromJSON(obj.inboundRateLimit),
      outboundRateLimit: types.RateLimitTokenBucket.fromJSON(obj.outboundRateLimit),
    });
  }
