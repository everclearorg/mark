...
export const layout = borsh.struct([borsh.u64('destChainSelector'), types.SVM2AnyMessage.layout('message')]);
 ...
 */
export function getFee(args: GetFeeArgs, accounts: GetFeeAccounts, programId: PublicKey = PROGRAM_ID) {
